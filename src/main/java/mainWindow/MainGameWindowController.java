...
public class MainGameWindowController {
     ...
     */
    private LevelModel levelModel1 = JsonData.getLevelModel1();
    ...
    public void initialize() {
        ...
        gamePane.heightProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> observableValue, Number oldValue, Number newValue) {
                ...
                double basicPolygonHeight = JsonData.getLevelModel1().getBasicSurfaceHeight();
                double basicSpaceCraftHeight = JsonData.getLevelModel1().getBasicSpaceCraftHeight();
